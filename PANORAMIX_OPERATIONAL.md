...
| Stamp north-star Done / unlock cloud from stub jobs, a catalog API, the editor, files browse, runs UX, or the G7 probe | **Rejected** — G1–G7 are seams / an honest thinner stamp; epic [#1](https://github.com/guypayeur/panoramix-guest-dsl/issues/1) remains open; cloud stays locked |
