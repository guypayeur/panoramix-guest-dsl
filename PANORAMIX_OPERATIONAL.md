...
| Fold Cognito / Getafix / Anthropic SDK into chat | **Rejected** — G8 is stdlib + optional `ANTHROPIC_API_KEY` or `DSL_CHAT_STUB`; persist is G6 Bearer |
