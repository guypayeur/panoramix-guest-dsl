...
class CatalogStoreTests(unittest.TestCase):
    ...
    def test_list_and_get_stub(self) -> None:
        ...
        self.assertNotIn("cupy", got["content"].lower())
        ...
        self.assertNotIn("getafix", json.dumps(got).lower())
        self.assertNotIn("cognito", json.dumps(got).lower())
...
class CatalogHttpTests(unittest.TestCase):
    ...
    def test_info_specs_without_ui(self) -> None:
        ...
        self.assertNotIn("getafix", blob.lower())
